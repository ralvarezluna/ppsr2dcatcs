 ...
 * </p>
 * <ul>
 *   <li>{@link ppsr_coremetamodel.impl.ContactPointImpl#getContactName <em>Contact Name</em>}</li>
 *   <li>{@link ppsr_coremetamodel.impl.ContactPointImpl#getMeansOfContact <em>Means Of Contact</em>}</li>
 *   <li>{@link ppsr_coremetamodel.impl.ContactPointImpl#getContactDetails <em>Contact Details</em>}</li>
 *   <li>{@link ppsr_coremetamodel.impl.ContactPointImpl#getContactPointType <em>Contact Point Type</em>}</li>
 *   <li>{@link ppsr_coremetamodel.impl.ContactPointImpl#getContactEmail <em>Contact Email</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ContactPointImpl extends EObjectImpl implements ContactPoint {
	 ...
	 * @ordered
	 */
	protected static final String MEANS_OF_CONTACT_EDEFAULT = null;
	 ...
	 * @ordered
	 */
	protected static final String CONTACT_DETAILS_EDEFAULT = null;
	 ...
	 * @ordered
	 */
	protected static final String CONTACT_POINT_TYPE_EDEFAULT = null;
	...
	protected EClass eStaticClass() {
		return ppsrmetamodelPackage.Literals.CONTACT_POINT;
	}
	...
	public void setContactName(String newContactName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ppsrmetamodelPackage.CONTACT_POINT__CONTACT_NAME, oldContactName, contactName));
	}
	...
	public void setMeansOfContact(String newMeansOfContact) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ppsrmetamodelPackage.CONTACT_POINT__MEANS_OF_CONTACT, oldMeansOfContact, meansOfContact));
	}
	...
	public void setContactDetails(String newContactDetails) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ppsrmetamodelPackage.CONTACT_POINT__CONTACT_DETAILS, oldContactDetails, contactDetails));
	}
	...
	public void setContactPointType(String newContactPointType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ppsrmetamodelPackage.CONTACT_POINT__CONTACT_POINT_TYPE, oldContactPointType, contactPointType));
	}
	...
	public void setContactEmail(String newContactEmail) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ppsrmetamodelPackage.CONTACT_POINT__CONTACT_EMAIL, oldContactEmail, contactEmail));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ppsrmetamodelPackage.CONTACT_POINT__CONTACT_NAME:
				return getContactName();
			case ppsrmetamodelPackage.CONTACT_POINT__MEANS_OF_CONTACT:
				return getMeansOfContact();
			case ppsrmetamodelPackage.CONTACT_POINT__CONTACT_DETAILS:
				return getContactDetails();
			case ppsrmetamodelPackage.CONTACT_POINT__CONTACT_POINT_TYPE:
				return getContactPointType();
			case ppsrmetamodelPackage.CONTACT_POINT__CONTACT_EMAIL:
