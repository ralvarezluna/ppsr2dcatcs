 ...
 * </p>
 * <ul>
 *   <li>{@link dcatcs.impl.ProjectMediaImpl#getProjectMediaFile <em>Project Media File</em>}</li>
 *   <li>{@link dcatcs.impl.ProjectMediaImpl#getProjectMediaType <em>Project Media Type</em>}</li>
 *   <li>{@link dcatcs.impl.ProjectMediaImpl#getProjectMediaCredit <em>Project Media Credit</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ProjectMediaImpl extends EObjectImpl implements ProjectMedia {
	...
	protected EClass eStaticClass() {
		return DcatcsPackage.Literals.PROJECT_MEDIA;
	}
	...
	public void setProjectMediaFile(String newProjectMediaFile) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DcatcsPackage.PROJECT_MEDIA__PROJECT_MEDIA_FILE, oldProjectMediaFile, projectMediaFile));
	}
	...
	public void setProjectMediaType(String newProjectMediaType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DcatcsPackage.PROJECT_MEDIA__PROJECT_MEDIA_TYPE, oldProjectMediaType, projectMediaType));
	}
	...
	public void setProjectMediaCredit(String newProjectMediaCredit) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DcatcsPackage.PROJECT_MEDIA__PROJECT_MEDIA_CREDIT, oldProjectMediaCredit, projectMediaCredit));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DcatcsPackage.PROJECT_MEDIA__PROJECT_MEDIA_FILE:
				return getProjectMediaFile();
			case DcatcsPackage.PROJECT_MEDIA__PROJECT_MEDIA_TYPE:
				return getProjectMediaType();
			case DcatcsPackage.PROJECT_MEDIA__PROJECT_MEDIA_CREDIT:
