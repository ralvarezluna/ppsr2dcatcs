 ...
 * </p>
 * <ul>
 *   <li>{@link dcatcs.impl.ProjectGeographicLocationImpl#getProjectPinLatitude <em>Project Pin Latitude</em>}</li>
 *   <li>{@link dcatcs.impl.ProjectGeographicLocationImpl#getProjectPinLongitude <em>Project Pin Longitude</em>}</li>
 *   <li>{@link dcatcs.impl.ProjectGeographicLocationImpl#getProjectGeographicCoverage <em>Project Geographic Coverage</em>}</li>
 *   <li>{@link dcatcs.impl.ProjectGeographicLocationImpl#getProjectGeographicCoverageCentroidLatitude <em>Project Geographic Coverage Centroid Latitude</em>}</li>
 *   <li>{@link dcatcs.impl.ProjectGeographicLocationImpl#getProjectGeographicCoverageCentroidLongitude <em>Project Geographic Coverage Centroid Longitude</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ProjectGeographicLocationImpl extends EObjectImpl implements ProjectGeographicLocation {
	 ...
	 * @ordered
	 */
	protected static final BigDecimal PROJECT_PIN_LATITUDE_EDEFAULT = new BigDecimal("0");
	 ...
	 * @ordered
	 */
	protected static final BigDecimal PROJECT_PIN_LONGITUDE_EDEFAULT = new BigDecimal("0");
	 ...
	 * @ordered
	 */
	protected static final String PROJECT_GEOGRAPHIC_COVERAGE_EDEFAULT = "undefined";
	 ...
	 * @ordered
	 */
	protected static final BigDecimal PROJECT_GEOGRAPHIC_COVERAGE_CENTROID_LATITUDE_EDEFAULT = new BigDecimal("0");
	 ...
	 * @ordered
	 */
	protected static final BigDecimal PROJECT_GEOGRAPHIC_COVERAGE_CENTROID_LONGITUDE_EDEFAULT = new BigDecimal("0");
	...
	protected EClass eStaticClass() {
		return DcatcsPackage.Literals.PROJECT_GEOGRAPHIC_LOCATION;
	}
	...
	public void setProjectPinLatitude(BigDecimal newProjectPinLatitude) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DcatcsPackage.PROJECT_GEOGRAPHIC_LOCATION__PROJECT_PIN_LATITUDE, oldProjectPinLatitude, projectPinLatitude, !oldProjectPinLatitudeESet));
	}
	...
	public void unsetProjectPinLatitude() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, DcatcsPackage.PROJECT_GEOGRAPHIC_LOCATION__PROJECT_PIN_LATITUDE, oldProjectPinLatitude, PROJECT_PIN_LATITUDE_EDEFAULT, oldProjectPinLatitudeESet));
	}
	...
	public void setProjectPinLongitude(BigDecimal newProjectPinLongitude) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DcatcsPackage.PROJECT_GEOGRAPHIC_LOCATION__PROJECT_PIN_LONGITUDE, oldProjectPinLongitude, projectPinLongitude, !oldProjectPinLongitudeESet));
	}
	...
	public void unsetProjectPinLongitude() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, DcatcsPackage.PROJECT_GEOGRAPHIC_LOCATION__PROJECT_PIN_LONGITUDE, oldProjectPinLongitude, PROJECT_PIN_LONGITUDE_EDEFAULT, oldProjectPinLongitudeESet));
	}
	...
	public void setProjectGeographicCoverage(String newProjectGeographicCoverage) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DcatcsPackage.PROJECT_GEOGRAPHIC_LOCATION__PROJECT_GEOGRAPHIC_COVERAGE, oldProjectGeographicCoverage, projectGeographicCoverage, !oldProjectGeographicCoverageESet));
	}
	...
	public void unsetProjectGeographicCoverage() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, DcatcsPackage.PROJECT_GEOGRAPHIC_LOCATION__PROJECT_GEOGRAPHIC_COVERAGE, oldProjectGeographicCoverage, PROJECT_GEOGRAPHIC_COVERAGE_EDEFAULT, oldProjectGeographicCoverageESet));
	}
	...
	public void setProjectGeographicCoverageCentroidLatitude(BigDecimal newProjectGeographicCoverageCentroidLatitude) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DcatcsPackage.PROJECT_GEOGRAPHIC_LOCATION__PROJECT_GEOGRAPHIC_COVERAGE_CENTROID_LATITUDE, oldProjectGeographicCoverageCentroidLatitude, projectGeographicCoverageCentroidLatitude, !oldProjectGeographicCoverageCentroidLatitudeESet));
	}
	...
	public void unsetProjectGeographicCoverageCentroidLatitude() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, DcatcsPackage.PROJECT_GEOGRAPHIC_LOCATION__PROJECT_GEOGRAPHIC_COVERAGE_CENTROID_LATITUDE, oldProjectGeographicCoverageCentroidLatitude, PROJECT_GEOGRAPHIC_COVERAGE_CENTROID_LATITUDE_EDEFAULT, oldProjectGeographicCoverageCentroidLatitudeESet));
	}
	...
	public void setProjectGeographicCoverageCentroidLongitude(BigDecimal newProjectGeographicCoverageCentroidLongitude) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DcatcsPackage.PROJECT_GEOGRAPHIC_LOCATION__PROJECT_GEOGRAPHIC_COVERAGE_CENTROID_LONGITUDE, oldProjectGeographicCoverageCentroidLongitude, projectGeographicCoverageCentroidLongitude));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DcatcsPackage.PROJECT_GEOGRAPHIC_LOCATION__PROJECT_PIN_LATITUDE:
				return getProjectPinLatitude();
			case DcatcsPackage.PROJECT_GEOGRAPHIC_LOCATION__PROJECT_PIN_LONGITUDE:
				return getProjectPinLongitude();
			case DcatcsPackage.PROJECT_GEOGRAPHIC_LOCATION__PROJECT_GEOGRAPHIC_COVERAGE:
				return getProjectGeographicCoverage();
			case DcatcsPackage.PROJECT_GEOGRAPHIC_LOCATION__PROJECT_GEOGRAPHIC_COVERAGE_CENTROID_LATITUDE:
				return getProjectGeographicCoverageCentroidLatitude();
			case DcatcsPackage.PROJECT_GEOGRAPHIC_LOCATION__PROJECT_GEOGRAPHIC_COVERAGE_CENTROID_LONGITUDE:
